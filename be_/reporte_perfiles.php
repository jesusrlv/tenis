      ...
      <tbody id="myTable2">
        ...
        $x = 0;
          while($row_sql_vendedor = $resultado_sql_vendedor->fetch_assoc()){
            ...
            echo'<td class="text-center"><a href="reporte_venta.php?id='.$row_sql_vendedor['id'].'"><span class="badge bg-warning text-dark"><i class="bi bi-journal"></i> Reporte</span></a></td>';
