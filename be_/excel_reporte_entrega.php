...
<main>
<h2 class="mb-5 bg-light p-5 text-center featurette-heading" style="margin:18px;">Reporte <span class="text-muted">Entregas</span> (<?php echo $rowSQLEntregas['nombre'] ?>)</h2>
