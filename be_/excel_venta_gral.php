...
<main>
<h2 class="mb-5 bg-light p-5 text-center featurette-heading" style="margin:18px;">Venta <span class="text-muted">General (<?php echo $fecha_reporte ?>)</span></h2>
    ...
    <table class="table table-light table-striped mb-3 table-hover align-middle">
      <thead class="text-center table-dark align-middle">
        <tr>
          ...
          <th scope="col" class="h6"><i class="bi bi-tag"></i><br>Precio</th>
          ...
          while($row_sql = $resultado_sql->fetch_assoc()){
            ...
            echo'<td class="text-center">'.$row_sql['clave_rastreo_int'].'</td>';
              ...
              elseif($row_sql['apartado']==2){
                ...
                echo'<td class="text-center">No aprobado</button></td>';
              }
